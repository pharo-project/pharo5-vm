/* Automatically generated by
   ...
   from
	NBCogit * NativeBoost-CogPlugin-GuillermoPolito.19 uuid: acc98e51-2fba-4841-a965-2975997bba66
 */
static char __buildInfo[] = "NBCogit * NativeBoost-CogPlugin-GuillermoPolito.19 uuid: acc98e51-2fba-4841-a965-2975997bba66 " __DATE__ ;
...
{
	// Cogit>>#compileTrampolineFor:callJumpBar:numArgs:arg:arg:arg:arg:saveRegs:resultReg:
	;
	genSmalltalkToCStackSwitch();
	if (cStackAlignment > BytesPerWord) {
...
{
	// Cogit>>#genTrampolineFor:called:callJumpBar:numArgs:arg:arg:arg:arg:saveRegs:resultReg:appendOpcodes:
    sqInt startAddress;
