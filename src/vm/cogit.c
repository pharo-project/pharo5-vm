/* Automatically generated by
	CCodeGenerator * VMMaker.oscog-EstebanLorenzano.768, VMMaker.oscog-eem.771 uuid: 1abbe9c7-13f0-4972-9779-d982037d7f17
   from
	StackToRegisterMappingCogit * VMMaker.oscog-EstebanLorenzano.768, VMMaker.oscog-eem.771 uuid: 1abbe9c7-13f0-4972-9779-d982037d7f17
 */
static char __buildInfo[] = "StackToRegisterMappingCogit * VMMaker.oscog-EstebanLorenzano.768, VMMaker.oscog-eem.771 uuid: 1abbe9c7-13f0-4972-9779-d982037d7f17 " __DATE__ ;
...
{
	// CogObjectRepresentationForSpur>>#checkValidInlineCacheTag:
...
{
	// CogObjectRepresentationFor32BitSpur>>#genConvertIntegerToSmallIntegerInScratchReg:
	/* begin LogicalShiftLeftCq:R: */
...
{
	// CogObjectRepresentationForSpur>>#genStoreCheckReceiverReg:valueReg:scratchReg:
...
{
	// CogObjectRepresentationFor32BitSpur>>#getInlineCacheClassTagFrom:into:
    AbstractInstruction *entryLabel;
...
{
	// CogObjectRepresentationForSpur>>#inlineCacheTagForInstance:
	if (isImmediate(oop)) {
		if ((oop & 1)) {
return ((0 << 1) | 1);
		}
...
{
	// CogObjectRepresentationForSpur>>#markAndTraceLiteral:
	if (couldBeObject(literal)) {
